...
public final class JavaTaggerTest {
    ...
    @Test
    public void t2() {
        check(new String[] { "is", "default", "scheme", "caching" }, new String[] { "verb", "noun", "noun", "adjective" });
    }
    
    @Test
    public void t3() {
        check(new String[] { "key", "pressed", "children", "started" }, new String[] { "noun", "adjective", "noun", "adjective" });
    }
